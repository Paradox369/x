            ...
            <div class="mt-5 h-0 flex-1 overflow-y-auto px-2">
              <nav class="flex h-full flex-col">
                <div class="space-y-1">
                  ...
                  <.link patch="#" class="text-indigo-100 hover:bg-indigo-800 hover:text-white group flex items-center rounded-md py-2 px-3 text-sm font-medium">
                  ...
                  <.link patch="#" class="bg-indigo-800 text-white group flex items-center rounded-md py-2 px-3 text-sm font-medium" aria-current="page">
